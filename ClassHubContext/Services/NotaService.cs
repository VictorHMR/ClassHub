...
namespace ClassHub.ClassHubContext.Services
{
    public class NotaService
    {
        ...
        public async Task InserirNotaAsync(LancarNotaRequestDTO nota)
        {
        ...
        public async Task EditarNotaAsync(EditarNotaRequestDTO novaNota)
        {
        ...
        public async Task DeletarNotaAsync(int idNota)
        {
        ...
        public async Task<List<ListarNotasAlunoResponseDTO>> ListarNotasAluno(int idAlunoTurma)
        {
